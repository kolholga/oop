...
//ДЗ от 14.12.2020
/*
 1.Создать класс Town
   Свойства:
    -название (name)
    -год остования города (year)
   Заполняется через конструктор

2.Создать класс Country
  Свойство : listCountry = []
  Методы:
  addTown() в аргумент принимает объект класса Town и дописывает в конец массива listCountry,
  а также добавляем(записываем) сериализованный объект в куки setcookie()
*/